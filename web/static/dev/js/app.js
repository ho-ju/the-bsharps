var app = angular.module('theBsharpsApp', ['ui.bootstrap.dropdown', 'mgcrea.ngStrap', 'ngAnimate']);
...
app.controller("navigation", ["$scope", "$http", "$location", "$timeout", "$rootScope", "$window", "apiService", function($scope, $http, $location, $timeout, $rootScope, $window, apiService) {
    ...
    $rootScope.defaultSeason = $scope.defaultSeason = "17s"; // set in global-bars.php
